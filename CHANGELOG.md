...
## kooker (1.3.17) - 2024-08-28

* Update docker tools url location

## kooker (1.3.16) - 2024-04-09
...
## kooker (1.3.13) - 2024-02-05

* kooker improve binary executables selection
* kooker fix fakechroot parsing of so, exec_path and add cmd subst
* kooker implement minor pylint compliance improvements
* kooker mode Pn make links2symlinks disabled by default in config: closes #412
* New kookertools 1.2.11 tarball
* kookertools mode Fn glibc fix dladdr(), dlopen(), dlmopen(), dl_iterate_phdr()
* kookertools mode Fn glibc add dladdr1()
* kookertools mode Fn glibc add execvpe(), execveat()
* kookertools mode Fn glibc add getauxval()
* kookertools mode Fn glibc add scandirat(), scandirat64()
* kookertools mode Fn glibc change stat64(), lstat64(), stat()
* kookertools mode Fn glibc add narrowing of program_invocation_name
* kookertools mode Fn glibc improve command substitution
* kookertools mode Fn musl fix dladdr(), dlopen(), dlmopen(), dl_iterate_phdr()
* kookertools mode Fn musl execvpe()
* kookertools mode Fn musl improve command substitution
* kookertools mode Fn added support for Alpine 3.19 (x86_64)
* kookertools mode Fn added support for Fedora 39 (x86_64, aarch64, ppc64le)
* kookertools mode Rn include runc 1.1.12

## kooker (1.3.12) - 2023-11-02

* Fix unit tests, no modifications w.r.t. 1.3.11

## kooker (1.3.11) - 2023-10-23
...
* Improve image metadata generated by kooker on import: closes #398

## kooker (1.3.10) - 2023-07-03
...
* Build kookertools 1.2.10 and set it as default
* The kookertools support for Fn now includes Ubuntu 23:04, Fedora 38,
...
## kooker (1.3.8) - 2023-03-24

* Build kookertools 1.2.9 and set it as default
* Add Fn support for Ubuntu:22
* Remove files to be installed
* Set Fn preference to use runc

## kooker (1.3.7) - 2023-01-24

* Remove deprecated unit tests. kooker is the same as version 1.3.6

## kooker (1.3.6) - 2023-01-19

* Re-implement kooker namespace: closes #380
* Login fails all the time: closes #379
* Ignore image loading if already exists: closes #378

## kooker (1.3.5) - 2022-10-21
...
* Fix issue with logical links in the kooker executable path
...
## kooker (1.3.4) - 2022-08-26

* Fix 2 unit tests

## kooker (1.3.3) - 2022-08-23

* Image list does not truncate long names: closes #349
* Fix conditional warning in verify image
* Fix and improve kooker high level tests

## kooker (1.3.2) - 2022-08-17
...
* Update minimum kooker tools tarball to 1.2.8
...
* Fix issues on running kooker in googlecolab: closes #286
...
* Add --nobanner to kooker run

## kooker (1.2.7) - 2021-01-26
...
* Added scripts tests kooker: `utils/kooker_test.sh utils/kooker_test-run.sh`

## kooker (1.1.8) - 2021-06-16

* Last 1.1.x release
* Fix Rn modes to enable containers execution from readonly dirs
* Documentation centralized installation and readonly setups

## kooker (1.1.7) - 2021-02-21
...
* kooker unexpectedly uses P1 exec mode instead of P2: closes #274
...
## kooker (1.1.4-1) - 2020-01-10

* Fix run --location
* Fix kooker integrated help
...
* Added `KOOKER_USE_PROOT_EXECUTABLE` env var to select proot location
* Added `KOOKER_USE_RUNC_EXECUTABLE` env var to select runc location
* Added `KOOKER_USE_SINGULARITY_EXECUTABLE` env var to select singularity
* Added `KOOKER_DEFAULT_EXECUTION_MODE` env var to select default execution mode
...
* Fixes for kooker in ARM aarch64
...
* Improve the installation of kookertools: closes #220, #228
...
* Improve download of kooker utils
...
* Export containers in both docker and kooker format
* Import containers docker and kooker format
...
* Add environment variable `KOOKER_KEYSTORE`: closes #75
* Prevent creation of .kooker when `KOOKER_KEYSTORE` is used: closes #75

## kooker (1.0.4) - 2017-09-26

* Documentation fixes

## kooker (1.0.3) - 2017-03-30
...
## kooker (1.0.1) - 2017-01-31

* Minor bugfixes
* Executable name changed from kooker.py to kooker
