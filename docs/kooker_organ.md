# kooker organization of classes

Repository path kooker/kooker
...
* kooker.py - class Main(object):
* cmdparser.py - class CmdParser(object):
* cli.py -     class KookerCLI(object): This is the command line implementation
* config.py -  class Config(object):
* tools.py -   class KookerTools(object):
