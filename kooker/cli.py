...
class KookerCLI(object):
    ...
    def do_export(self, cmdp):
        ...
        --clone                    :export in clone (kooker) format
        """
        to_file = cmdp.get("-o")
        clone = cmdp.get("--clone")
        if to_file:
    ...
    def do_setup(self, cmdp):
        ...
        --purge                 :clean mountpoints and files created by kooker
    ...
    def do_install(self, cmdp):
        ...
        utools = KookerTools(self.localrepo)
        if purge:
            utools.purge()
...
Commands:
  ...
  setup --purge                 :clean mountpoints and files created by kooker
...
See: https://github.com/indigo-dc/kooker/blob/master/SUMMARY.md
            """)
        return self.STATUS_OK
