# -*- coding: utf-8 -*-
"""Parser for kooker commands and options"""
...
class CmdParser(object):
    ...
    The general command format is:
      $ kooker command arg1 arg2 --opta --optb=zzz
    """
    ...
    def _get_option(self, opt_name, opt_list, consumed, opt_multiple):
        ...
        The options may exist in the first and third part of the kooker
        command line.
        """
        all_args = []
        pos = 0
    ...
    def _get_param(self, opt_name, opt_list, consumed, consumed_params):
        ...
        The CLI of kooker has 3 parts, first options, second command name
