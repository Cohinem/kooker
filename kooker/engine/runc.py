...
class RuncEngine(ExecutionEngineCommon):
    ...
    def select_runc(self):
        ...
        if self.executable == "KOOKER" or not self.executable:
            self.executable = ""
            image_list = []
            eng = ["runc", "crun", "runsc"]
        ...
        if not os.path.exists(self.executable):
            ...
            Msg().out("Info: Host architecture might not be supported by",
                      ...
                      "KOOKER_USE_RUNC_EXECUTABLE",
                      "\n      or choose other execution mode with: kooker",
    ...
    def _proot_overlay(self, proot_mode="P2"):
        ...
        cont_executable = "/.kooker/bin/" + os.path.basename(host_executable)
