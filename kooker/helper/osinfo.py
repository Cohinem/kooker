...
from kooker.helper.archinfo import ArchInfo
...
class OSInfo(ArchInfo):
    ...
    def arch_from_binaries(self, target="KOOKER"):
    ...
    def arch_from_metadata(self, target="KOOKER"):
    ...
    def is_same_arch(self, other_root_dir="/", target="KOOKER"):
