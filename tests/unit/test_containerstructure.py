...
# -*- coding: utf-8 -*-
"""
kooker unit tests: ContainerStructure
"""

from unittest import TestCase, main
from unittest.mock import patch, Mock
from kooker.container.structure import ContainerStructure
...
class ContainerStructureTestCase(TestCase):
    ...
    @patch('kooker.container.structure.Msg')
    ...
    @patch('kooker.container.structure.os.path.exists')
    ...
    @patch('kooker.container.structure.Unique.uuid')
    @patch('kooker.container.structure.Msg')
    ...
    @patch('kooker.container.structure.os.listdir')
    @patch('kooker.container.structure.os.path.isdir')
    @patch('kooker.container.structure.os.path.dirname')
    @patch('kooker.container.structure.os.path.basename')
    @patch('kooker.container.structure.Uprocess.get_output')
    @patch('kooker.container.structure.HostInfo.cmd_has_option')
    @patch('kooker.container.structure.FileUtil.remove')
    ...
    @patch('kooker.container.structure.HostInfo')
    @patch('kooker.container.structure.subprocess.call')
    ...
    @patch('kooker.container.structure.FileUtil.tar')
    @patch('kooker.container.structure.Msg')
    ...
    @patch.object(ContainerStructure, '_chk_container_root')
    @patch('kooker.container.structure.FileUtil.copydir')
    @patch('kooker.container.structure.Unique.uuid')
    @patch('kooker.container.structure.Msg')
