#!/usr/bin/env python
"""
kooker unit tests: ElfPatcher
"""

from unittest import TestCase, main
from unittest.mock import patch, Mock
from kooker.helper.elfpatcher import ElfPatcher
...
class ElfPatcherTestCase(TestCase):
    ...
    @patch('kooker.helper.elfpatcher.HostInfo')
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    ...
    @patch('kooker.helper.elfpatcher.FileUtil.find_exec')
    @patch('kooker.helper.elfpatcher.Msg')
    @patch('kooker.helper.elfpatcher.os.path.exists')
    @patch('kooker.helper.elfpatcher.HostInfo.arch')
    @patch('kooker.helper.elfpatcher.FileUtil.find_file_in_dir')
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    def test_02_select_patchelf(self, mock_path, mock_find,
        ...
        mock_findexec.return_value = "/home/user/.kooker/bin/patchelf"
        mock_arch.return_value = "arm"
        elfp = ElfPatcher(self.local, self.contid)
        output = elfp.select_patchelf()
        self.assertEqual(output, "/home/user/.kooker/bin/patchelf")

        mock_msg.level = 0
        Config.conf['use_patchelf_executable'] = \
            "/home/user/.kooker/bin/patchelf"
        mock_arch.return_value = "arm"
        ...
        mock_msg.level = 0
        Config.conf['use_patchelf_executable'] = "KOOKER"
        mock_arch.return_value = "arm"
        mock_exists.return_value = True
        mock_find.return_value = "/home/user/.kooker/bin/patchelf-arm"
        elfp = ElfPatcher(self.local, self.contid)
        output = elfp.select_patchelf()
        self.assertEqual(output, "/home/user/.kooker/bin/patchelf-arm")
    ...
    # Needs reviewing
    @patch('kooker.helper.elfpatcher.Uprocess.get_output')
    @patch('kooker.helper.elfpatcher.os.path.islink')
    @patch('kooker.helper.elfpatcher.os.stat')
    @patch('kooker.helper.elfpatcher.os.walk')
    @patch('kooker.helper.elfpatcher.os.access')
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    ...
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    @patch('kooker.helper.elfpatcher.os.path.exists')
    @patch('kooker.helper.elfpatcher.FileUtil.getdata')
    @patch('kooker.helper.elfpatcher.FileUtil.putdata')
    ...
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    @patch('kooker.helper.elfpatcher.FileUtil.remove')
    @patch.object(ElfPatcher, 'guess_elf_loader')
    @patch.object(ElfPatcher, '_walk_fs')
    @patch.object(ElfPatcher, 'get_patch_last_path')
    @patch.object(ElfPatcher, 'get_original_loader')
    ...
    @patch.object(ElfPatcher, 'get_container_loader')
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    @patch('kooker.helper.elfpatcher.FileUtil.size')
    @patch('kooker.helper.elfpatcher.FileUtil.copyto')
    @patch('kooker.helper.elfpatcher.FileUtil.getdata')
    @patch('kooker.helper.elfpatcher.FileUtil.putdata')
    ...
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    @patch('kooker.helper.elfpatcher.os.path.dirname')
    @patch('kooker.helper.elfpatcher.Uprocess.get_output')
    ...
    @patch('kooker.helper.elfpatcher.os.path.isfile')
    @patch('kooker.helper.elfpatcher.os.path.realpath')
    @patch('kooker.helper.elfpatcher.os.access')
    @patch('kooker.helper.elfpatcher.os.walk')
