#!/usr/bin/env python
"""
kooker unit tests: ExecutionEngineCommon
"""

from unittest import TestCase, main
from unittest.mock import Mock, patch
from kooker.engine.base import ExecutionEngineCommon
...
class ExecutionEngineCommonTestCase(TestCase):
    ...
    @patch('kooker.engine.base.HostInfo.cmd_has_option')
    ...
    @patch('kooker.engine.base.Msg')
    @patch('kooker.engine.base.HostInfo')
    ...
    @patch('kooker.engine.base.FileUtil.find_exec')
    ...
    @patch('kooker.engine.base.MountPoint')
    @patch('kooker.engine.base.FileUtil.isdir')
    ...
    @patch('kooker.engine.base.os.path.exists')
    @patch('kooker.engine.base.Uvolume.split')
    ...
    @patch('kooker.engine.base.NixAuthentication.get_home')
    ...
    @patch('kooker.engine.base.Uvolume.cleanpath')
    @patch('kooker.engine.base.Uvolume.split')
    ...
    @patch('kooker.engine.base.Msg')
    @patch('kooker.engine.base.Uenv')
    @patch('kooker.engine.base.os.path.isdir')
    @patch('kooker.engine.base.FileUtil.cont2host')
    ...
    @patch('kooker.engine.base.ContainerStructure.get_container_meta')
    @patch('kooker.engine.base.ContainerStructure.get_container_attr')
    ...
    @patch('kooker.engine.base.os.path.isfile')
    @patch('kooker.engine.base.os.path.islink')
    @patch('kooker.engine.base.FileBind')
    ...
    def test_17__user_from_str(self):
        ...
        userstr = "user1"
        res = {"user": userstr}
        str_exmode = 'kooker.helper.nixauth.NixAuthentication'
    ...
    @patch('kooker.engine.base.Msg')
    @patch('kooker.engine.base.HostInfo')
    @patch('kooker.engine.base.NixAuthentication')
    ...
    def test_20__fill_user(self, mock_auth, mock_hinfo):
        ...
        self.assertEqual(ex_eng.opt["gecos"], "*KOOKER*")

    @patch.object(ExecutionEngineCommon, '_fill_user')
    @patch('kooker.engine.base.os.getgroups')
    @patch('kooker.engine.base.FileUtil.copyto')
    @patch('kooker.engine.base.FileUtil.mktmp')
    @patch('kooker.engine.base.FileUtil.umask')
    @patch('kooker.engine.base.NixAuthentication')
    ...
    @patch('kooker.engine.base.Msg')
    @patch('kooker.engine.base.os.path.basename')
    ...
    @patch('kooker.engine.base.os.environ.copy')
    @patch('kooker.engine.base.os.environ')
    ...
    @patch('kooker.engine.base.HostInfo.username')
    ...
    @patch('kooker.engine.base.FileUtil.getdata')
