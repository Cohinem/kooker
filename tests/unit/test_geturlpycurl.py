...
# -*- coding: utf-8 -*-
"""
kooker unit tests: GetURLpyCurl
"""
...
class GetURLpyCurlTestCase(TestCase):
    ...
    # @patch('kooker.utils.curl.pycurl.Curl')
    ...
    #     curl_patch = patch("kooker.utils.curl.CurlHeader")
    #     curlhdr = curl_patch.start()
    #     mock_curlhdr = Mock()
    #     curlhdr.return_value = mock_curlhdr
    #
    #     pyc_patch = patch("kooker.utils.curl.pycurl.Curl")
