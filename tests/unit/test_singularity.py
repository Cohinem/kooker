#!/usr/bin/env python
"""
kooker unit tests: SingularityEngine
"""
...
class SingularityEngineTestCase(TestCase):
    ...
    @patch('kooker.engine.singularity.HostInfo.arch')
    @patch('kooker.engine.singularity.FileUtil.find_file_in_dir')
    @patch('kooker.engine.singularity.FileUtil.find_exec')
    ...
    @patch('kooker.engine.singularity.NixAuthentication.get_home')
    @patch('kooker.engine.singularity.os.path.isdir')
    ...
    @patch('kooker.engine.singularity.FileUtil.mkdir')
    ...
    @patch('kooker.engine.singularity.Msg')
    ...
    @patch('kooker.engine.singularity.NixAuthentication')
    @patch('kooker.engine.singularity.HostInfo.username')
    @patch('kooker.engine.singularity.Msg')
    ...
    @patch('kooker.engine.singularity.subprocess.call')
    @patch('kooker.engine.singularity.Unique.uuid')
    @patch('kooker.engine.singularity.FileBind')
    @patch('kooker.engine.singularity.os.path.isdir')
